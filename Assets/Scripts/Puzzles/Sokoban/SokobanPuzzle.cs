...
public class SokobanPuzzle : PuzzleLogic
{
	[Tooltip("The floor tile scriptable object.")]
    [SerializeField] private SokobanFloorTile floorTile = null;

	[Tooltip("The sliding box scriptable object.")]
    [SerializeField] private SokobanBoxTile boxTile = null;

	[Tooltip("The player scriptable object.")]
    [SerializeField] private SokobanPlayerTile playerTile = null;

	[Tooltip("The wall tile scriptable object.")]
    [SerializeField] private SokobanWallTile wallTile = null;

	[Tooltip("The goal scriptable object.")]
    [SerializeField] private SokobanGoalTile goalTile = null;

	[Tooltip("The player sprite prefab.")]
    [SerializeField] private SpriteRenderer playerFloatSpritePrefab = null;

	[Tooltip("The sliding box sprite prefab.")]
    [SerializeField] private SpriteRenderer boxFloatSpritePrefab = null;
	...
	void Update()
    {
        ...
        if (boxPositions.Contains(next1))
        {
			...
			this.puzzleComplete = this.CheckSolution();
        }
    ...
    {
		foreach(Vector3Int pos in this.boxPositions)
		{
			if(!this.goalPositions.Contains(pos))
			{
				return false;
			}
		}
